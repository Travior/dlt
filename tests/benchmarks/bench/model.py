...
class Event(TypedDict, total=False):
    """One benchmark event merged from worker JSONL files."""
...
class EventSet:
    """Immutable view over benchmark events with small aggregation helpers."""
...
class RunResult:
    """Everything measured for one benchmark case across repetitions."""
    ...
    def save(self, label: str) -> Path:
        from tests.benchmarks.bench import store
